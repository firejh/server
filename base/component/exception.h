 ...
 * Author: JiangHeng
 *
 * Created: 2016-10-31 18:13 +0800
 *
 * Modified: 2016-10-31 18:13 +0800
 *
 * Description: 
 */
...
#define EXCEPTION(ExceptionType, formatMsg...)\
    throw ExceptionType(base::component::format(formatMsg), __FILE__, __PRETTY_FUNCTION__, __LINE__);


#define SYS_EXCEPTION(ExceptionType, formatMsg...)\
    throw ExceptionType(base::component::format(formatMsg), __FILE__, __PRETTY_FUNCTION__, __LINE__, errno);
