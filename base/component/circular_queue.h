 ...
 * Author: JiangHeng
 *
 * Created: 2016-10-31 18:11 +0800
 *
 * Modified: 2016-10-31 18:11 +0800
 *
 * Description: 
 */
...
{
public:
    TYPEDEF_PTR(CircularQueue);
    CREATE_FUN_MAKE(CircularQueue);

    explicit CircularQueue(uint32_t maxSize = 512)
    : m_data(maxSize)
    {
    }
